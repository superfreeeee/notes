...
│   │   ├──webapp   
│   │   │   └──WEB-INF  // web應用文件目錄
│   │   └──resources  // 項目資源，如.yaml mapper.xml
│   └──test
│       ├──java 
│       └──resources 
└──target   // 打包輸出目錄
...
### Clean生命週期
```java
1. pre-clean  // clean前工作
2. clean      // 移除上一次構建的文件
3. post-clean //  clean後工作
```
...
<project>
  <!-- 項目全球標示符，生成路徑對應域名/xxx/yyy/zzz -->
  <groupId>xxx.yyy.zzz</groupId>
  <!-- 構件標示符 -->
  <artifactId>aaa-bbb-ccc</artifactId>
  <!-- 項目當前版本，格式：主版本.次版本.增量版本-限定版本 -->
  <version>1.0-SNAPSHOT</version>

  <!-- 父項目座標，groupId, artifactId, version -->
  <parent>
    <!-- 全球唯一標示符(組織、域名)) -->
    <groupId/>
    <!-- 項目構建標示符 -->
